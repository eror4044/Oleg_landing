  ...
  return (
    <section className="relative w-full h-full overflow-hidden text-white">
      ...
      >
        ...
        <p className="text-[1.1rem] text-white/90 max-w-[550px] mb-10">
        ...
        <div className="flex flex-col items-center md:items-start gap-3">
          ...
          <div className="relative flex items-center">
            <div className="rounded-full bg-gradient-to-r from-[#ff4fa2] to-[#ff7e5f] px-10 py-4 text-[1.1rem] font-semibold text-white shadow-[0_0_35px_rgba(255,79,162,0.45)]">
              Приєднуйся сьогодні!
            </div>
